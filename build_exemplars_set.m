...
% imdbExemplars_.images.classes = imdbExemplars.images.classes(perm);
              ...
              imdbExemplars_.images.id = cat(2, imdbExemplars.images.id, imdb.images.id(perm));
              imdbExemplars_.images.name = cat(2, imdbExemplars.images.name, imdb.images.name(perm));
              imdbExemplars_.images.labels = cat(2, imdbExemplars.images.labels, imdb.images.labels(perm));
              imdbExemplars_.images.set = cat(2, imdbExemplars.images.set, imdb.images.set(perm));
              imdbExemplars_.images.label = cat(2, imdbExemplars.images.label, imdb.images.label(perm));
